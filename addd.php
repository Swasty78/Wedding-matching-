...
$p_price = $_POST['p_price'];
   ...
   $stmt=$conn->prepare("insert into package(p_id,p_name,p_details,p_price)
     values(?,?,?,?)");
      $stmt->bind_param("issi", $p_id,$p_name,$p_details,$p_price);
      $stmt->execute();
     ...
     $conn->close();
?>
<a href="project.html"><input type="submit" value="add more"></a>
<script>
function myFunction() {
